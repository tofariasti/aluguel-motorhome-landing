(function () {
  ...
  function initWhatsAppForm() {
    ...
    form.addEventListener('submit', function (e) {
      ...
      var msg = '*Olá! Quero reservar um motor home na RoadHome Premium*\n\n';
      msg += '📋 *Dados do cliente*\n';
      msg += '• Nome: ' + nome + '\n';
      msg += '• Telefone: ' + telefone + '\n\n';
      msg += '🚐 *Locação*\n';
      msg += '• Categoria: ' + categoria + '\n';
      if (modelo) msg += '• Modelo: ' + modelo + '\n';
      if (passageiros) msg += '• Passageiros: ' + passageiros + '\n';
  ...
  function showToast() {
    ...
    toast.style.cssText =
      'position:fixed;top:100px;right:2rem;background:linear-gradient(135deg,#FF8C33,#e57a2b);' +
